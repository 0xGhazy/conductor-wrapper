package com.conductor.core.conductor.metadata.service;

import com.conductor.core.conductor.metadata.adapter.TaskAdapter;
import com.conductor.core.conductor.metadata.adapter.WorkflowAdapter;
...
import com.conductor.core.exception.BadRequest;
import com.conductor.core.exception.InternalServerError;
import com.conductor.core.exception.NotFound;
...
public class MetaDataService {
    ...
    public List<TaskDefDto> fetchAllTaskDefinitions() {
        ...
        try {
            ...
            throw new InternalServerError("Internal server error occur");
        }
    }
    ...
    public WorkflowDefDto createWorkflowDefinition(@Valid WorkflowDefDto payload) {
        ...
        if (workflowDefOptional.isPresent()) {
            ...
            throw new BadRequest("Workflow definition is already exist");
        }
