package com.vodafone.vcs.conductor.action.database.api;

import com.vodafone.vcs.conductor.action.database.dto.Query;
import com.vodafone.vcs.conductor.action.database.dto.QueryResult;
...
import com.vodafone.vcs.conductor.action.database.enums.QueryType;
import com.vodafone.vcs.conductor.action.database.service.DatasourceService;
import com.vodafone.vcs.conductor.action.database.service.QueryService;
...
public class DatabaseAPI {
    ...
    public QueryResult run(Query query) {
        ...
        QueryResult out = QueryResult.builder()
                .queryId(queryId)
                .status(QueryExecStatus.FAILED)
                .build();
